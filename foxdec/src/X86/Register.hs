...
overlapping r =
  filter (allp [(/=) r, haveSameRealReg r, areNotSeparate r]) allRegisters
...
areNotSeparate AH AL = False
areNotSeparate AL AH = False
areNotSeparate BH BL = False
areNotSeparate BL BH = False
areNotSeparate CH CL = False
areNotSeparate CL CH = False
areNotSeparate DH DL = False
areNotSeparate DL DH = False
areNotSeparate _ _ = True
